...
namespace EBinder.Controllers
{
    ...
    public class ReferenceTypeController : BaseController
    {
        ...
        public ActionResult Create()
        {
            ...
            ViewBag.ReferenceCategoryID = new SelectList(db.ReferenceCategories, "ReferenceCategoryID", "CategoryName_" + Session["Language"].ToString());
            return View();
        }
        ...
        public ActionResult Create(ReferenceType referencetype)
        {
            ...
            ViewBag.ReferenceCategoryID = new SelectList(db.ReferenceCategories, "ReferenceCategoryID", "CategoryName_" + Session["Language"].ToString(), referencetype.ReferenceCategoryID);
